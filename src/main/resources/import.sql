...
insert into listings (id, equity_type, ipo_date, company_id, exchange_id) values ('UGI', 'COMMON_STOCK', '2002-04-12', 'UGI', 'NYSE');
insert into listings (id, equity_type, ipo_date, company_id, exchange_id) values ('AAPL', 'COMMON_STOCK', '1999-12-14', 'AAPL', 'XNAS');
insert into listings (id, equity_type, ipo_date, company_id, exchange_id) values ('NVDA', 'COMMON_STOCK', '2003-10-11', 'NVDA', 'XNAS');
insert into listings (id, equity_type, ipo_date, company_id, exchange_id) values ('WDAY', 'COMMON_STOCK', '2003-10-11', 'WDAY', 'XNAS');
insert into listings (id, equity_type, ipo_date, company_id, exchange_id) values ('OTP', 'COMMON_STOCK', '1995-08-10', 'OTP', 'BUD');
insert into listings (id, equity_type, ipo_date, company_id, exchange_id) values ('MOL', 'COMMON_STOCK', '1998-10-11', 'MOL', 'BUD');
insert into listings (id, equity_type, ipo_date, company_id, exchange_id) values ('OTPb', 'COMMON_STOCK', '2003-03-05', 'OTP', 'LSE');
